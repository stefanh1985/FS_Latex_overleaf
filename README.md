# Selbstlernkurs Latex als Alternative zu Word für Studierende 💻
<div style="width:100%;height:0;padding-bottom:178%;position:relative;"><iframe src="https://giphy.com/embed/BBbjTB2wIhS1UAkMKe" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/study-hard-fhwn-fh-wiener-neustadt-BBbjTB2wIhS1UAkMKe">via GIPHY</a></p>

Herzlich willkommen ❤️ zum Selbstlernkurs über LaTeX!
Als sozialpädagogische Fachkraft hast du täglich die Gelegenheit, bedeutungsvolle Inhalte zu erstellen und zu teilen, sei es in Bildungsplänen, Berichten oder Präsentationen. Mit LaTeX, einem leistungsstarken Werkzeug zur Textverarbeitung, wirst du in der Lage sein, deine Dokumente professionell und effektiv zu gestalten. Dieser Kurs ist speziell darauf ausgelegt, dir die Grundlagen von LaTeX für Ausbildung und Studiem nahezubringen. Viel Spaß und Erfolg 🐞

Der Kurs ist in verschiedene Module Aspekte und Module unterteilt, die aufeinander aufbauen, es ist allso sinnvoll diese nacheinander zu bearbeiten. Die nummerierten Module befassen sich mit Latex als Schreibprogramm. Die Buchstabenmodule befassen sich darüber hinaus mit Latex als Präsentationsprogramm.

---
Legende:
ℹ️= zentrale Hinweise
⚓= Festlegung
❗= Tipp
▶️= Aufgab(en)
---
 ...
 **Modul 2** Latex lokal installieren ODER Cloudbasiert mittels overleaf nutzen

 **Modul 3** Grundgerüst schaffen

 **Modul 4** Formatierungen festlegen (fett, kursiv, Zeilenabstand)

 **Modul 5** Bilder einbinden

 **Modul 6** Interne und externe Links
 ...
 **Modul A** Latex für Präsentationen - eine erste Präsentation erstellen

 **Modul B** Folien einteilen, Tabellen und Bilder

 **Modul C** Literaturverzeichnis und Sytles
 ---
...
# Modul 2 Latex lokal installieren ODER Cloudbasiert mittels overleaf nutzen 🌨️
...
>> ⚓ In den folgenden Modulen wird ausschließlich mit der Latexversion  von Overlaef.com gearbeitet

Nach der Anmeldung gilt es prinzipiell Grundeinstellungen im Dokument vorzunehmen, wie folgendes Video zeigt

<iframe width="560" height="315" src="https://www.youtube.com/embed/THLWaXCujbw?si=rUJRueTuQmN7sTqu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>


Auf der folgenden [Webseite](https://www.uni-frankfurt.de/53485609/latexsheet.pdf) sind die zentralsten Befehle nacheinander aufgeführt.

Eine Differenziertere Darstellung samt Erklärung findet sich in diesem [PDF] (https://ins.uni-bonn.de/media/public/staff/feuersaenger/MeineKurzReferenz.pdf?pk=86)

>❗Tipp: Es empfiehlt sich gerade zu Beginn die kurzreferenzen auszudurcken und neben den PC zu legeen, bis die wichtigsten Befehle in Alltagshandeln überführt werden konnte.

# Modul 4 Formatierungen festlegen (fett, kursiv, unterstrichen, Zeilenabstand) ↔️
<div style="width:100%;height:0;padding-bottom:75%;position:relative;"><iframe src="https://giphy.com/embed/3o6Zt6ML6BklcajjsA" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/cat-sleep-keyboard-3o6Zt6ML6BklcajjsA">via GIPHY</a></p>
...
> ❗Tipp 1: Folgende [Webseite](https://www.learnlatex.org/de/lesson-11) erklärt wie **Schriften und Abstände** generiert werden können und bietet gleichzeitig den dementsprechende Code als Vorlage an.

> ❗Tipp 2: Folgende [Webseite](https://www.learnlatex.org/de/lesson-08) erklärt wie **Tabellen** generiert werden können und bietet gleichzeitig den dementsprechende Code als Vorlage an.

# Modul 5 Bilder einbinden 🖼️
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/9BWqSkBoZZOcTRd0M1" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/Onetz-podcast-fotografie-fotopodcast-9BWqSkBoZZOcTRd0M1">via GIPHY</a></p>

Wie in klassischen Schreibprogrammen kann Latex Bilder einbinden und auch als Abbildungsverzeichnis wiedergeben, wie folgendes Video zeigt

<iframe width="560" height="315" src="https://www.youtube.com/embed/PbVA55ACD4c?si=gLNLFko5zLULLyPC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

> ❗Tipp: Folgende [Webseite](https://www.learnlatex.org/de/lesson-07) erklärt das Einbinden von Bildern unter der Überschrift **Erscheinung von Grafiken verändern** und bietet gleichzeitig den dementsprechende Code als Vorlage an.

# Modul 6 Interne und externe Links 🔗
 <div style="width:100%;height:0;padding-bottom:96%;position:relative;"><iframe src="https://giphy.com/embed/MDrq4Gwd0i4m4mGwCr" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/paw-iamaslydog-mauler-MDrq4Gwd0i4m4mGwCr">via GIPHY</a></p>
 
  Die Formulierung interne und externe Links mag zunächst für etwas Verwirrung sorgen.***Interne Links*** meint, dass innerhalb des Textes einen Verbindung bestehen muss. Dies ist zum Beispiel für das Generiieren des Inhaltsverzeichnisses oder aber des Indexes relevant- es hilft sozusagen innerhalb des Dokumentes zu navigieren.
 ***Exteren Links*** hingegen meint  Links, die bspw. auf Webseiten außerhalb des Dokumentes verweisen. Diese beiden Linkformen werden in Latext anders behandelt als dies in klassischen Schreibprogrammen der fall ist, wie folgendes Video zeigt.

 <iframe width="560" height="315" src="https://www.youtube.com/embed/Ecr8fT7zZSQ?si=OMknmo4OdOjfI31X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

 > ❗Tipp: Folgende [Webseite](https://www.learnlatex.org/de/lesson-09) erklärt wie **Querverweise** generiert werden können und bietet gleichzeitig den dementsprechende Code als Vorlage an.

# Modul 7 Dokumenten in Spalten unterteilen + Abstract einfügen 🪗
 <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/37nUaPANNaSwqNCduS" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/dmax-steel-buddies-37nUaPANNaSwqNCduS">via GIPHY</a></p>
 
 Die Unterteilung von Dokumenten  in Spalten ist gerade in Papers häufig ein Thema. Für klassische Seminar- und Hausarbeiten nicht so häufig, daher wird das Thema hier nur kurz gestreift.
...
# Modul 9 Wenn ich am Code verzweifle 🥺
Auch die beste Erkläärung kann dann und wann scheintern und die Frustration  ist dann ggf. groß. Dies muss aber nicht so sein, denn es gibt Hilfe.

 > ❗Tipp I: Folgende [Webseite](https://www.learnlatex.org/de/lesson-09) erklärt in Lektionen die einzelnen Stationen, die ein Latexdokument durchlaufen muss und bietet gleichzeitig den dementsprechende Code als Vorlage an- also Surft BEVOR ihr verzweifelt dort vorbei. Ihr könnt die Codeschnipsel sogar direkt in overleaf übernehmen.

  > ❗Tipp II: Folgende [Webseite](http://www.stat.rub.de/teaching/latex/latex01.pdf) enthält die Grundsätze von Latex und latex Präsentation als PowerPoint Präsentation, wer diese Form bevorzug schaut dort nach.
  
# Latex ist nicht nur Text... ✍️
 <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/3o6Mb5W48vOsqke0ec" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/season-20-the-simpsons-20x19-3o6Mb5W48vOsqke0ec">via GIPHY</a></p>
 
 Latex kann im gegensatz zu klassischen Schreibprogrammen nicht nur Textdateien generieren, sondern auch Präsentationen generieren...darum geht es in den folgenden zwei Modulen.

# Modul A Latex für Präsentationen - eine erste Präsentation erstellen 📸

<iframe width="560" height="315" src="https://www.youtube.com/embed/2qTF4loDROo?si=1jimmRN4be0Pimcj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

# Modul B  Folien einteilen, Tabellen und Bilder 🖼️

<iframe width="560" height="315" src="https://www.youtube.com/embed/iabso7ilRKY?si=6Kc8DaFmqfeIY1Me" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

# Modul C Literaturverzeichnis und Styles  😝
<iframe width="560" height="315" src="https://www.youtube.com/embed/WYBAp1pO9_I?si=DebGv7kcNY6DmgU-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

  > ❗Tipp: Auf der folgenden[Webseite](https://www.dropbox.com/s/yfxoq9valm94vu9/Pr%C3%A4sentation.zip?dl=0) gibt es eine Präsentationsvorlage